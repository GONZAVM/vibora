...
public class Vibora extends JFrame {
    ...
    public class ImagenSnake extends JPanel {
        public void paintComponent(Graphics g) {
            ...
            g.setColor(new Color(0, 255, 0)); // Cambiado a verde
            g.setFont(new Font("TimesRoman", Font.BOLD, 80)); // Tamaño de fuente grande
            g.drawString("Snake", 350, 100); // Texto "Snake" en la parte superior
            if (gameOver) {
